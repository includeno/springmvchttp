...
class DirectValueControllerTest {
    @Autowired
    MockMvc mockMvc;
    ...
    @Test
    void getValueDirect() throws Exception {
        String url="/getValueDirect";
    ...
    @Test
    void postValueDirect() throws Exception {
    ...
    @Test
    void putValueDirect() throws Exception {
        String url="/putValueDirect";
        Enumeration<String> keys = MapUtil.map.keys();
        String key="";
        while (keys.hasMoreElements()){
            key=keys.nextElement();
    ...
    @Test
    void deleteValueDirect() throws Exception {
        String url="/deleteValueDirect";
        Enumeration<String> keys = MapUtil.map.keys();
        String key="";
        while (keys.hasMoreElements()){
            key=keys.nextElement();
