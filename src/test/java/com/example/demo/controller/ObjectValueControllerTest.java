...
class ObjectValueControllerTest {
    ...
    @Test
    void getValueObject() throws Exception {
        String url="/getValueObject";
    ...
    @Test
    void postValueObject() throws Exception {
        String url="/postValueObject";
        Enumeration<String> keys = MapUtil.map.keys();
        String key="";
        while (keys.hasMoreElements()){
            key=keys.nextElement();
    ...
    @Test
    void putValueObject() throws Exception {
        String url="/putValueObject";
        Enumeration<String> keys = MapUtil.map.keys();
        String key="";
        while (keys.hasMoreElements()){
            key=keys.nextElement();
    ...
    @Test
    void deleteValueObject() throws Exception{
        String url="/deleteValueObject";
        Enumeration<String> keys = MapUtil.map.keys();
        String key="";
        while (keys.hasMoreElements()){
            key=keys.nextElement();
